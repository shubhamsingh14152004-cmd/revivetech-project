...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sagar Tech — Sell Dead Phones & Repair Your Phone" },
      { name: "description", content: "Sell your dead phone for top cash, or book expert same-day cleanroom repairs at Sagar Tech." },
      { name: "author", content: "Sagar Tech" },
      { property: "og:site_name", content: "Sagar Tech" },
      { property: "og:title", content: "Sagar Tech — Sell Dead Phones & Repair Your Phone" },
      { property: "og:description", content: "Sell your dead phone for top cash, or book expert same-day cleanroom repairs at Sagar Tech." },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "en_IN" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@SagarTech" },
    ],
    links: [
      {
        rel: "stylesheet",
