...
const FAQS = [
  ...
  {
    question: "What warranty comes with water damage repairs?",
    answer:
      "Repaired components and boards receive ReviveTech's 90-Day VIP Warranty against recurrence of repaired shorts and faults.",
  },
];
...
export const Route = createFileRoute("/water-damage-repair")({
  head: () => ({
    meta: [
      {
        title: "Phone Water Damage Repair & Data Recovery Near Me | ReviveTech",
      },
      {
        name: "description",
        content:
          "Emergency mobile phone water damage repair. Ultrasonic circuit cleaning, motherboard micro-soldering & critical data recovery for iPhone, Samsung & Android.",
      },
      {
        name: "keywords",
        content:
          "phone water damage repair, dropped phone in water fix, liquid damage phone repair, iPhone water damage repair, wet phone data recovery, motherboard ultrasonic cleaning",
      },
      {
        property: "og:title",
        content: "Phone Water Damage Repair & Data Recovery Near Me | ReviveTech",
      },
      {
